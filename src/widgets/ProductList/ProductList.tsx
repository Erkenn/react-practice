...
export function ProductList({ view = 'grid' }: ProductListProps) {
  ...
  return (
    <div className={styles.catalog}>
        ...
        <div className={styles.filtersRow}>
          ...
          <div className={styles.viewSwitcher}>
            <SegmentedControl
              ...
              value={internalView}
              onChange={(val: string) => setInternalView(val as 'grid' | 'list')}
            />
          </div>
        </div>
      </div>
      ...
      {filteredProducts.length === 0 ? (
        ...
        <div className={`${styles.productGrid} ${styles[`productGrid_${internalView}`]}`}>
          {filteredProducts.map((product) => (
            <ProductCard
              ...
              variant={internalView === 'list' ? 'detailed' : 'compact'}
              onAddToCart={() =>
                addToCart({
